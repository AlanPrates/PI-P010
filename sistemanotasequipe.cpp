...
int main() {
    int N;
    cout << "Digite o número máximo de alunos: ";
    cin >> N;
    ...
    while (true) {
        ...
        if (it != alunos.end()) {
            cout << "Notas atuais do aluno " << nomeAluno << ": Nota 1: " << it->nota1 << ", Nota 2: " << it->nota2 << endl;
            ...
            while (true) {
                ...
                cout << "Notas atualizadas do aluno " << nomeAluno << ": Nota 1: " << it->nota1 << ", Nota 2: " << it->nota2 << endl;
            }
        } else {
            cout << "Aluno não encontrado." << endl;
        }
    ...
    for (const auto& aluno : alunos) {
        cout << "Aluno: " << aluno.nome << ", Nota 1: " << aluno.nota1 << ", Nota 2: " << aluno.nota2 << ", Média: " << aluno.media;
        if (aluno.media >= 7.0) {
            cout << " (Aprovado)";
        } else {
            cout << " (Reprovado)";
